...
define(["require", "exports", "./dialog", "brandup-ui"], function (require, exports, dialog_1, brandup_ui_1) {
    ...
    var FormDialog = /** @class */ (function (_super) {
        ...
        FormDialog.prototype.addTextBox = function (name, title, options, value) {
            var field = new TextField(name, options);
            this.addField(title, field);
            field.setValue(value);
        };
        FormDialog.prototype.addComboBox = function (name, title, options, items, value) {
            var field = new ComboBoxField(name, options);
            this.addField(title, field);
            field.addItems(items);
            field.setValue(value);
        };
        FormDialog.prototype.addComboBox2 = function (name, title, options, value, url, map) {
            var field = new ComboBoxField(name, options);
            this.addField(title, field);
            brandup_ui_1.ajaxRequest({
                url: url,
...
//# sourceMappingURL=dialog-form.js.map