...
namespace BrandUp.Pages.Controllers
{
    ...
    public class PageCollectionCreateController(
        PageService pageService,
        PageCollectionService pageCollectionService,
        IPageLinkGenerator pageLinkGenerator,
        PageMetadataManager pageMetadataManager,
        IWebsiteContext websiteContext) : FormController<PageCollectionCreateForm, PageCollectionCreateValues, PageCollectionModel>
    {
        IPage page;
