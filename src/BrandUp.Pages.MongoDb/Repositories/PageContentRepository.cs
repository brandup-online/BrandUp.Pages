...
{
    public class PageContentRepository : IEditSessionRepository
    {
        private static readonly Expression<Func<EditSessionDocument, EditSession>> ProjectionExpression;
        readonly IMongoCollection<EditSessionDocument> documents;
        readonly IMongoCollection<PageContentDocument> contentDocuments;

        static PageContentRepository()
        {
            ProjectionExpression = it => new EditSession
            {
                Id = it.Id,
        ...
        public async Task<IEditSession> CreateEditAsync(IPage page, string userId, CancellationToken cancellationToken = default)
        {
            ...
            var document = new EditSessionDocument
            {
                Id = Guid.NewGuid(),
        ...
        public async Task<IEditSession> FindEditByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IEditSession> FindEditByUserAsync(IPage page, string userId, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IDictionary<string, object>> GetContentAsync(IEditSession pageEdit, CancellationToken cancellationToken = default)
        {
        ...
        public async Task SetContentAsync(IEditSession pageEdit, IDictionary<string, object> contentData, CancellationToken cancellationToken = default)
        {
            var contentDataDocument = MongoDbHelper.DictionaryToBsonDocument(contentData);
            var updateDefinition = Builders<EditSessionDocument>.Update.Set(it => it.Content, contentDataDocument);
        ...
        public async Task DeleteEditAsync(IEditSession pageEdit, CancellationToken cancellationToken = default)
        {
